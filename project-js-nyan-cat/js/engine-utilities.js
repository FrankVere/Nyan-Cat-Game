...
const addScoreboard = (root) => {
  ...
  whiteBox.style.zIndex = 1001;
  whiteBox.style.position = "absolute";
  whiteBox.style.top = "0px";
  whiteBox.style.height = `55px`;
  whiteBox.style.width = `55px`;
  whiteBox.style.fontSize = "2.5em";
  whiteBox.style.color = "red";
  whiteBox.classList = "#arcadeFont";
  root.append(whiteBox);
  return whiteBox;
};
